...
SRCCLR= test/classifierTest.cpp src/Classifier/liblinearclassifier.cpp src/TrainTestSplitter/traintestsplitter.cpp src/helpers/helpers.cpp src/Preprocessing/index.cpp src/Preprocessing/wordmap.cpp src/Preprocessing/punktpp.cpp src/helpers/helpers.cpp src/helpers/errorHandler.cpp
